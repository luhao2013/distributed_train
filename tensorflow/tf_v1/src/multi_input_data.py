...
if __name__ == '__main__':
    ...
    EPOCHS = 3
    BATCH_SIZE = 36
    TRAIN_RECODER_PATH = "../data/train.tfrecords"
    TEST_RECODER_PATH = "../data/test.tfrecords"
    if not os.path.exists("../data/"):
        os.makedirs("../data/")
    
    generate_tfrecoder(TRAIN_DATA_SIZE, TRAIN_RECODER_PATH)
    generate_tfrecoder(TEST_DATA_SIZE, TEST_RECODER_PATH)


    # Compute for epochs.
    for i in range(EPOCHS):
        train_next_element = get_data(TRAIN_RECODER_PATH)
